...
const scaling_values = {
  "Accounting": [57.4, 13.2],
  "Specialist": [68.9, 13.1],
  "Methods": [64.5, 13.2],
  "Physics": [62.3, 13.3],
  "Chemistry": [63.2, 13.1],
  ...
  "Biology": [57.4, 12.9],
  "English": [57.3, 13.3],
  "Applications": [55.4, 13.1],
  "Economics": [59.5, 13.3],
  "Japanese": [67.2, 14.7],
  "German": [63.1, 11.9],
  "Modern History": [57.7, 13.8],
  "Psychology": [57.2, 13.3]
};
...
function scaleScores() {
  ...
  for (const subject in subjects) {
    ...
    // Check if average exists and if scaling values exist for this subject
    if (average !== undefined && scaling_values[subject]) {
      subjects[subject]["Scaled Score"] =
        (average - scaling_values[subject][0]) / scaling_values[subject][1] * 14 + 60;
    } else {
      // If no average or no scaling values, set scaled score to 0 or remove it
      subjects[subject]["Scaled Score"] = 0;
    }
  }
